...
import { generateSourceImage } from '../services/gemini';
...
const Controls: React.FC<ControlsProps> = ({ config, setConfig, onImageUpload, onImageGenerated, onExport, onRecord }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const url = await generateSourceImage(prompt);
  ...
  return (
    <div className="w-full h-full bg-black/90 border-l border-gray-800 p-6 flex flex-col backdrop-blur-sm shadow-2xl overflow-y-auto">
      ...
      <p className="text-xs text-gray-500 mb-6 font-mono border-b border-gray-800 pb-4">
        图形粒子合成引擎
      </p>
      ...
      <div className="mb-8 space-y-4">
        ...
        <div className="relative">
          <span className="text-xs font-mono text-pink-500 block mb-2">AI 生成 (Gemini 2.5)</span>
