...
import { ImageModelNodeData } from '../../types';

interface ImageModelNodeProps {
  data: ImageModelNodeData;
  updateData: (newData: Partial<ImageModelNodeData>) => void;
  onGenerate: () => void;
  canGenerate: boolean;
  isGenerating: boolean;
}

const ImageModelNode: React.FC<ImageModelNodeProps> = ({ data, updateData, onGenerate, canGenerate, isGenerating }) => {
