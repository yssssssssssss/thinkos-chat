...
const Canvas: React.FC = () => {
  ...
  const executeImageToImage = async (modelNodeId: string) => {
    ...
    const seedreamSelected = selectedModels.some(m => m.id === 'doubao-seedream-4-0-250828' || m.id === 'doubao-seedream-4-5-251128');
    ...
    try {
      ...
      if (type === 'fix') {
        ...
        if (USE_REAL_IMAGE_API) {
          if (sourceImage.model === SEEDREAM_MODEL_ID || sourceImage.model === 'doubao-seedream-4-5-251128') {
